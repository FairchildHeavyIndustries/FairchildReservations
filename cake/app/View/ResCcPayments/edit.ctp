...
<?php echo $this->Form->create('ResCcPayment');?>
	<fieldset>
		<legend><?php echo __('Edit Res Cc Payment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ResCcPayment.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ResCcPayment.id'))); ?></li>
