<div class="cities index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('gMT_offset');?></th>
			<th><?php echo $this->Paginator->sort('dST_start');?></th>
			<th><?php echo $this->Paginator->sort('dST_end');?></th>
			<th><?php echo $this->Paginator->sort('dST_offset');?></th>
	...
	<tr>
		...
		<td><?php echo h($city['City']['currency']); ?>&nbsp;</td>
		<td><?php echo h($city['City']['position_x']); ?>&nbsp;</td>
		<td><?php echo h($city['City']['position_y']); ?>&nbsp;</td>
		<td><?php echo h($city['City']['gMT_offset']); ?>&nbsp;</td>
		<td><?php echo h($city['City']['dST_start']); ?>&nbsp;</td>
		<td><?php echo h($city['City']['dST_end']); ?>&nbsp;</td>
		<td><?php echo h($city['City']['dST_offset']); ?>&nbsp;</td>
		<td><?php echo h($city['City']['is_active']); ?>&nbsp;</td>
		<td class="actions">
